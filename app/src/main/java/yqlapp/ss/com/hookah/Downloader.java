...
/**
 * Created by Sidhanth on 8/3/2016.
 */
public class Downloader extends AsyncTask<String, Integer, ArrayList> {
    ...
    protected ArrayList doInBackground(String... params) {
        ...
        String yqlURL = "https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20local.search%20where%20zip%3D%27"+params[0]+"%27%20and%20query%3D%27hookah%27&format=json&callback=";
